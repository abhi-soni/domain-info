...
const Whois = (props) => {
    ...
    const rows = result === null ? [] : [
        ...
        {
            label: 'Nameservers', value: Object.entries(result.nameserver).map((ns) => {
                let [key, value] = ns;
                return <span key={key}>{value}<br /></span>;
            })
        },
        { label: 'IP Address', value: result.ips },
        { label: 'Creation Date:', value: result.created },
        { label: 'Updated Date', value: result.changed },
        { label: 'Whois Server', value: result.whoisserver },
        { label: 'Registry Expiry Date', value: result.expires },
        ...
        { label: 'Registrar Name', value: result.registrar.name },
        { label: 'Registrar ID', value: result.registrar.id || 'Not Available' },
        { label: 'Registrar Email', value: result.registrar.email || 'Not Available' },
        ...
        { label: 'Registrar URL', value: result.registrar.url || 'Not Available' },
        { label: 'Registrar Phone', value: result.registrar.phone || 'Not Available' }
